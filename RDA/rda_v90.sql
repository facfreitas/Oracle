REM rda_v90.sql
prompt <HR>
prompt <!--[ v90 | 9.0 Version Specific ]-->
prompt <a name="v90"></a>
...
----------------------------------------------------
prompt <!--[ 90ts | Tablespaces ]-->
prompt <A NAME="90ts"></a>
...
prompt ~RDA_html_tab2
----------------------------------------------------
prompt <!--[ 90lmts | LM Tablespaces ]-->
prompt <A NAME="90lmts"></a>
...
prompt ~RDA_html_tab2
----------------------------------------------------
prompt <!--[ 90dfs | Database Files ]-->
prompt <A NAME="90dfs"></a>
...
prompt ~RDA_html_tab2
----------------------------------------------------
prompt <!--[ 90tfs | Temporary Files ]-->
prompt <A NAME="90tfs"></a>
...
prompt ~RDA_html_tab2
----------------------------------------------------
prompt <!--[ 90dbasao | DBA Stmt Audit Options ]-->
prompt <A NAME="90dbasao"></a> 
...
prompt ~RDA_html_tab2
----------------------------------------------------
prompt <!--[ 90dbapao | DBA_Priv Audit Options ]-->
prompt <A NAME="90dbapao"></a> 
