CREATE OR REPLACE PACKAGE SYS.soap_api_sap AS
-- --------------------------------------------------------------------------
...
GRANT EXECUTE ON SYS.SOAP_API_SAP TO EAE;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EDOCS;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EEP_CORE;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EEP_FINANCE;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EEP_HUMANRESOURCES;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EEP_PONTO;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EESOCIAL;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EGCON;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EGDOC;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EGEDOC;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EMRB;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO EPROD;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO ERF;

GRANT EXECUTE ON SYS.SOAP_API_SAP TO GOLIATH;
CREATE OR REPLACE PACKAGE BODY SYS.soap_api_sap AS
-- --------------------------------------------------------------------------
-- Name         : http://www.oracle-base.com/dba/miscellaneous/soap_api.sql
-- Author       : Tim Hall
-- Description  : SOAP related functions for consuming web services.
...
-- ---------------------------------------------------------------------
BEGIN
  p_env :=  '<?xml version="1.0" encoding="ISO-8859-1"?>'||
